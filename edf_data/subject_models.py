...
for i in range(1,16):
    ...
    preprocessed_data_file = '/Users/malihalac/desktop/BCI_Hackathon/github/BCI_Hackathon/edf_data/' + './preprocessed_dataset/dataIMM_epochsec-'+str(epoch_sec)+'_schema_'+nomeschema+'_P{:02d}'.format(i)+'.h5'
    ...
    modelname = "model_all_electrodes_fully_connected_bidirectional_P{:02d}".format(i)
    # Get past models
