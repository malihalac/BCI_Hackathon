...
for band, fmin, fmax in iter_freqs:
    ...
    raw = mne.io.read_raw_edf(raw_fname)
    raw.pick_types(meg='grad', eeg=True)  # we just look at gradiometers
    raw.load_data()
    ...
    epochs = mne.Epochs(raw, events, event_id, tmin, tmax, baseline=baseline,
                        reject=dict(grad=4000e-13, eeg=350e-6),
                        preload=True)
...
if __name__ == '__main__':
    directory = "/Users/Suket/desktop/PycharmProjects/BCI_Hackathon/edf_data/"
    save_path = "/Users/Suket/desktop/PycharmProjects/BCI_Hackathon/edf_data/"
